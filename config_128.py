...
EXPERIMENT_NAME = "test_1000_epochs_4x4_base_128x128_lr2e_4" # para ver os experimentos ja feitos, veja a pasta experiments

# --- configurações do dataset e do treinamento ---
EPOCHS = 1000
BATCH_SIZE = 32  # Conforme a secão de treinamento (4) do artigo
